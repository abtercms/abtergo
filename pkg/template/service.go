...
type Service interface {
	...
	Update(ctx context.Context, template Template, oldETag model.ETag) (Template, error)
...
func NewService(repository Repo, logger *slog.Logger) Service {
	return &service{
		logger: logger,
		repo:   repository,
	}
...
func (s *service) Update(ctx context.Context, entity Template, oldETag model.ETag) (Template, error) {
	if err := entity.Validate(); err != nil {
